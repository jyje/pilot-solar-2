...
엔드포인트를 사용해 그 과정을 완전히 건너뜁니다.

## 발견: Python 3.14는 아직 여기서 동작하지 않음

Case 04는 **3.13**을 고정합니다. 이 리포의 다른 uv 기반 Python
케이스인 Case 03도 원래 3.14였지만, 두 Python 케이스를 같은 버전으로
맞추기 위해 마찬가지로 3.13으로 내렸습니다.
